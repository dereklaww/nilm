...
class LabelHandler():
    @staticmethod
    def create_multilabels_from_many_buildings(data_per_building: Dict[int, Tuple[pd.DataFrame, MeterGroup, Dict]]) \
        ...
        for building in data_per_building.keys():
            ...
            labels_df = LabelHandler.create_multilabels_from_meters(df, metergroup, label2id)
    ...
    @staticmethod
    def create_multilabels_from_meters(meters: pd.DataFrame, meter_group: MeterGroup, labels2id: dict) -> pd.DataFrame:
        """
